...
const char* serverAddress = "http://192.168.29.108/SmartAttendanceByRFID/insert_teacher.php"; // Change it with your server address
  ...
  if (mfrc522.PICC_IsNewCardPresent()) {
    if (mfrc522.PICC_ReadCardSerial()) {
      ...
      if (cardUID != lastCardUID) {
        ...
        sendTeacherInfoToServer(teacherName, cardUID);
...
String getTeacherName() {
  Serial.println("Enter teacher name:");
...
void sendTeacherInfoToServer(String teacherName, String cardUID) {
  Serial.println("Sending teacher info to server: ");
  ...
  String postData = "teacher_name=" + teacherName + "&teacher_rfid=" + cardUID;
  int httpResponseCode = http.POST(postData);
  if (httpResponseCode == 200) {
    Serial.println("Teacher info sent successfully");
    ...
    Serial.print("Error sending teacher info: ");
